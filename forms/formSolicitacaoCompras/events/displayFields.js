function displayFields(form, customHTML) {
  ...
  var constraintColleague = DatasetFactory.createConstraint('colleaguePK.colleagueId', colleageID, colleageID, ConstraintType.MUST);
  var loginUsuarioAtual = DatasetFactory.getDataset('colleague', [], [constraintColleague], null);



  if (atividade == "0") {
    form.setValue('loginSolicitante', loginUsuarioAtual.getValue(0, "login"));
    form.setValue("dataHoraSolic", currentTime);
    form.setValue('solicitanteNome', loginUsuarioAtual.getValue(0, "colleagueName"));
  }
  if (atividade == "4") {
    form.setValue("dataCorrecao", currentTime);
    form.setValue('nomeCorrecao', loginUsuarioAtual.getValue(0, "colleagueName"));
  }
  if (atividade == "11") {
    form.setValue("dataCorrecao", currentTime);
    form.setValue('nomeCorrecao', loginUsuarioAtual.getValue(0, "colleagueName"));
  ...
  if (atividade == "5") {
    form.setValue("dataHoraAprov", currentTime);
    form.setValue('aprovadorNome', loginUsuarioAtual.getValue(0, "colleagueName"));
    form.setValue('aprovadorCargo', loginUsuarioAtual.getValue(0, "colleagueName"));
  }
}
